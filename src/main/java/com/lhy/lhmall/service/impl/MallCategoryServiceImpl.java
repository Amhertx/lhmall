...
import com.lhy.lhmall.common.MallCategoryLevelEnum;
import com.lhy.lhmall.common.ServiceResultEnum;
import com.lhy.lhmall.controller.vo.MallIndexCategoryVO;
import com.lhy.lhmall.controller.vo.SearchPageCategoryVO;
import com.lhy.lhmall.controller.vo.SecondLevelCategoryVO;
import com.lhy.lhmall.controller.vo.ThirdLevelCategoryVO;
import com.lhy.lhmall.dao.GoodsCategoryMapper;
import com.lhy.lhmall.dao.MallGoodsMapper;
import com.lhy.lhmall.entity.GoodsCategory;
import com.lhy.lhmall.service.MallCategoryService;
...
public class MallCategoryServiceImpl implements MallCategoryService {
    ...
    public String updateGoodsCategory(GoodsCategory goodsCategory) {
        ...
        if (goodsCategoryMapper.updateByIdSelective(goodsCategory) > 0) {
            return ServiceResultEnum.SUCCESS.getResult();
        }
        return ServiceResultEnum.DB_ERROR.getResult();
    }
    ...
    public SearchPageCategoryVO getCategoriesForSearch(Long categoryId) {
        ...
        GoodsCategory thirdLevelGoodsCategory = goodsCategoryMapper.selectById(categoryId);
        if (thirdLevelGoodsCategory != null && thirdLevelGoodsCategory.getCategoryLevel() == MallCategoryLevelEnum.LEVEL_THREE.getLevel()) {
            //获取当前三级分类的二级分类
            GoodsCategory secondLevelGoodsCategory = goodsCategoryMapper.selectById(thirdLevelGoodsCategory.getParentId());
